...
persona:
  ...
  core_principles:
    ...
    - **SINGLE FILE OUTPUT**: All sections append to docs/prd.md (never separate files)
...
content-creation-pattern:
  ...
  - **Full Content Presentation Requirements** (CRITICAL):
    ...
    **Examples**:
    ✅ CORRECT: Shows "## Feature Specifications\n\nUser Authentication System...[500 words of actual content]"
    ❌ WRONG: Shows "What's Included: Feature specs cover user flows, edge cases, dependencies"

    ✅ CORRECT: Shows complete section with all headers, paragraphs, lists, formatting
